...
public class ExceptionMessages {
	...
	public static final String BENEFICIARY_ALREDY_ADDED="Beneficiary has already been approved and added";
	...
	public static final String NO_CUSTOMERS ="No customers";
